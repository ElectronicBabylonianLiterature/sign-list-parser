...
describe('Values', () => {
  testEach(
    [createSign(['@v agar']), createValues({value: 'agar', subIndex: 1})],
    [createSign(['@v aš@v']), createValues({value: 'aš@v', subIndex: 1})],
    [createSign(['@v aš@c@90@v']), createValues({value: 'aš@c@90@v', subIndex: 1})],
    [createSign(['@v hul', '@v hula']), createValues({value: 'hul', subIndex: 1}, {value: 'hula', subIndex: 1})],
    [createSign(['@v mušda']), createValues({value: 'mušda', subIndex: 1})],
    [createSign(['@v ge₁₈']), createValues({value: 'ge', subIndex: 18})],
    [createSign(['@v ʾu₄']), createValues({value: 'ʾu', subIndex: 4})],
    [createSign(['@v sig₁₅@v']), createValues({value: 'sig@v', subIndex: 15})],
    [createSign(['@v 1(šarʾu)']), createValues({value: '1', subIndex: 1})],
    [createSign(['@v 1/2(iku)']), createValues({value: '1/2', subIndex: 1})],
    [createSign(['@v 9(aš@v@c)']), createValues({value: '9', subIndex: 1})],
    [createSign(['@v 4(diš)@v']), createValues({value: '4', subIndex: 1})],
    [createSign(['@v 9(diš@c)@v~a']), createValues({value: '9', subIndex: 1})],
    [createSign(['@v {kaš}ulušin']), createValues({value: '{kaš}ulušin', subIndex: 1})],
    [createSign(['@v uliₓ?']), createValues({value: 'uli'})],
    [createSign(['@v /šitlam/']), {values: []}],
    [createSign(['@v a₂⁻']), {values: []}],
    [createSign(['@v ur₅-ša₄']), {values: []}],
    [createSign(['@v uₓ(DIŠ)-gun₃']), {values: []}],
    [createSign(['@v san₂a₂']), {values: []}],
    [createSign(['@v{+ab₂}abrig']), {values: []}],
    [createSign(['@v du₅⁺']), {values: []}],
    [createSign(['@v īnuII']), {values: []}],
    [createSign(['@v [...]ri']), {values: []}],
    [createSign(['@v [...]']), {values: []}],
    [createSign(['@v ...gi']), {values: []}],
    [createSign(['@v ka...']), {values: []}],
    [createSign(['@v ?']), {values: []}],
...
describe('Deprecated value', () => {
  testEach(
    [createSign(['@v- a']), createValues({value: 'a', deprecated: true, subIndex: 1})]
  )
})
...
test('fakes are ignored', () => {
  const match = grammar.match('@sign DN\n@fake 1\n@end sign')
  const result = semantics(match).eval()
  expect(result).toEqual([])
})
