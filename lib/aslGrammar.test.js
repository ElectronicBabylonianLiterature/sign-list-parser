...
describe('Values', () => {
  testEach(
    ...
    [createSign(['@v ʾu₄']), {values: [{value: 'ʾu₄'}]}],
    [createSign(['@v 1(šarʾu)']), {values: [{value: '1(šarʾu)'}]}],
    [createSign(['@v 1/2(iku)']), {values: [{value: '1/2(iku)'}]}],
    [createSign(['@v 9(aš@v@c)']), {values: [{value: '9(aš@v@c)'}]}],
...
function evaluates (sign, parsed) {
  ...
  expect(result).toEqual(expect.objectContaining(parsed))
}
